...
CUDA_VISIBLE_DEVICES=1 python scripts/train_tumor_roi_0322.py \
    --medseg_root /home/pumengyu/medseg_project \
    --preprocessed_root /home/pumengyu/Task03_Liver_pt \
    --exp_root /home/pumengyu/experiments/twostage \
    --exp_name tumor_dynunet_roi_jitter_0322repro \
    --model dynunet \
    --epochs 300 \
    --batch_size 2 \
    --lr 0.003 \
...
CUDA_VISIBLE_DEVICES=0 python scripts/train_tumor_roi.py \
  ...
  --small_tumor_repeat_scale 1 \
  --no_tumor_repeat_scale 1 \
